...
def _spherical_harmonics(lmax: int, x: torch.Tensor, y: torch.Tensor, z: torch.Tensor) -> torch.Tensor:
    ...
    sh_2_0 = (1/2)*math.sqrt(5)*(sh_1_0*z + sh_1_2*x)
    sh_2_1 = (1/2)*math.sqrt(5)*(sh_1_0*y + sh_1_1*x)
    sh_2_2 = (1/6)*math.sqrt(15)*(-sh_1_0*x + 2*sh_1_1*y - sh_1_2*z)
    sh_2_3 = (1/2)*math.sqrt(5)*(sh_1_1*z + sh_1_2*y)
    sh_2_4 = (1/2)*math.sqrt(5)*(-sh_1_0*x + sh_1_2*z)
    if lmax == 2:
        return torch.stack([
            sh_0_0,
            sh_1_0, sh_1_1, sh_1_2,
    ...
    sh_3_1 = (1/3)*math.sqrt(7)*(sh_2_0*y + sh_2_1*z + sh_2_3*x)
    sh_3_2 = -1/30*math.sqrt(70)*sh_2_0*z + (2/15)*math.sqrt(70)*sh_2_1*y + (1/15)*math.sqrt(210)*sh_2_2*x + (1/30)*math.sqrt(70)*sh_2_4*x
    sh_3_3 = -1/15*math.sqrt(105)*sh_2_1*x + (1/5)*math.sqrt(35)*sh_2_2*y - 1/15*math.sqrt(105)*sh_2_3*z
    sh_3_4 = -1/30*math.sqrt(70)*sh_2_0*x + (1/15)*math.sqrt(210)*sh_2_2*z + (2/15)*math.sqrt(70)*sh_2_3*y - 1/30*math.sqrt(70)*sh_2_4*z
    sh_3_5 = (1/3)*math.sqrt(7)*(-sh_2_1*x + sh_2_3*z + sh_2_4*y)
    sh_3_6 = (1/6)*math.sqrt(42)*(-sh_2_0*x + sh_2_4*z)
    if lmax == 3:
        return torch.stack([
            sh_0_0,
            sh_1_0, sh_1_1, sh_1_2,
    ...
    sh_13_0 = (3/26)*math.sqrt(78)*(sh_12_0*z + sh_12_24*x)
    sh_13_1 = (3/13)*math.sqrt(3)*sh_12_0*y + (9/13)*math.sqrt(2)*sh_12_1*z + (9/13)*math.sqrt(2)*sh_12_23*x
    sh_13_2 = -3/130*math.sqrt(6)*sh_12_0*z + (36/65)*sh_12_1*y + (9/65)*math.sqrt(46)*sh_12_2*z + (9/65)*math.sqrt(46)*sh_12_22*x + (3/130)*math.sqrt(6)*sh_12_24*x
    sh_13_3 = -9/130*math.sqrt(2)*sh_12_1*z + (9/65)*math.sqrt(23)*sh_12_2*y + (3/130)*math.sqrt(1518)*sh_12_21*x + (9/130)*math.sqrt(2)*sh_12_23*x + (3/130)*math.sqrt(1518)*sh_12_3*z
    sh_13_4 = -9/65*sh_12_2*z + (9/130)*math.sqrt(154)*sh_12_20*x + (9/65)*sh_12_22*x + (6/65)*math.sqrt(66)*sh_12_3*y + (9/130)*math.sqrt(154)*sh_12_4*z
    sh_13_5 = (9/65)*math.sqrt(35)*sh_12_19*x + (3/65)*math.sqrt(15)*sh_12_21*x - 3/65*math.sqrt(15)*sh_12_3*z + (9/65)*math.sqrt(35)*sh_12_4*y + (9/65)*math.sqrt(35)*sh_12_5*z
    sh_13_6 = (3/65)*math.sqrt(285)*sh_12_18*x + (9/130)*math.sqrt(10)*sh_12_20*x - 9/130*math.sqrt(10)*sh_12_4*z + (18/65)*math.sqrt(10)*sh_12_5*y + (3/65)*math.sqrt(285)*sh_12_6*z
    sh_13_7 = (9/130)*math.sqrt(114)*sh_12_17*x + (9/130)*math.sqrt(14)*sh_12_19*x - 9/130*math.sqrt(14)*sh_12_5*z + (3/65)*math.sqrt(399)*sh_12_6*y + (9/130)*math.sqrt(114)*sh_12_7*z
    sh_13_8 = (9/130)*math.sqrt(102)*sh_12_16*x + (3/65)*math.sqrt(42)*sh_12_18*x - 3/65*math.sqrt(42)*sh_12_6*z + (36/65)*math.sqrt(3)*sh_12_7*y + (9/130)*math.sqrt(102)*sh_12_8*z
    sh_13_9 = (6/65)*math.sqrt(51)*sh_12_15*x + (9/65)*math.sqrt(6)*sh_12_17*x - 9/65*math.sqrt(6)*sh_12_7*z + (9/65)*math.sqrt(51)*sh_12_8*y + (6/65)*math.sqrt(51)*sh_12_9*z
    sh_13_10 = (18/65)*math.sqrt(5)*sh_12_10*z + (18/65)*math.sqrt(5)*sh_12_14*x + (9/130)*math.sqrt(30)*sh_12_16*x - 9/130*math.sqrt(30)*sh_12_8*z + (12/65)*math.sqrt(30)*sh_12_9*y
    sh_13_11 = (9/65)*math.sqrt(55)*sh_12_10*y + (9/130)*math.sqrt(70)*sh_12_11*z + (9/130)*math.sqrt(70)*sh_12_13*x + (3/130)*math.sqrt(330)*sh_12_15*x - 3/130*math.sqrt(330)*sh_12_9*z
    sh_13_12 = -9/65*math.sqrt(11)*sh_12_10*z + (18/65)*math.sqrt(14)*sh_12_11*y + (3/65)*math.sqrt(273)*sh_12_12*x + (9/65)*math.sqrt(11)*sh_12_14*x
    sh_13_13 = -9/65*math.sqrt(26)*sh_12_11*x + (3/5)*math.sqrt(3)*sh_12_12*y - 9/65*math.sqrt(26)*sh_12_13*z
    sh_13_14 = -9/65*math.sqrt(11)*sh_12_10*x + (3/65)*math.sqrt(273)*sh_12_12*z + (18/65)*math.sqrt(14)*sh_12_13*y - 9/65*math.sqrt(11)*sh_12_14*z
    sh_13_15 = -9/130*math.sqrt(70)*sh_12_11*x + (9/130)*math.sqrt(70)*sh_12_13*z + (9/65)*math.sqrt(55)*sh_12_14*y - 3/130*math.sqrt(330)*sh_12_15*z - 3/130*math.sqrt(330)*sh_12_9*x
    sh_13_16 = -18/65*math.sqrt(5)*sh_12_10*x + (18/65)*math.sqrt(5)*sh_12_14*z + (12/65)*math.sqrt(30)*sh_12_15*y - 9/130*math.sqrt(30)*sh_12_16*z - 9/130*math.sqrt(30)*sh_12_8*x
    sh_13_17 = (6/65)*math.sqrt(51)*sh_12_15*z + (9/65)*math.sqrt(51)*sh_12_16*y - 9/65*math.sqrt(6)*sh_12_17*z - 9/65*math.sqrt(6)*sh_12_7*x - 6/65*math.sqrt(51)*sh_12_9*x
    sh_13_18 = (9/130)*math.sqrt(102)*sh_12_16*z + (36/65)*math.sqrt(3)*sh_12_17*y - 3/65*math.sqrt(42)*sh_12_18*z - 3/65*math.sqrt(42)*sh_12_6*x - 9/130*math.sqrt(102)*sh_12_8*x
    sh_13_19 = (9/130)*math.sqrt(114)*sh_12_17*z + (3/65)*math.sqrt(399)*sh_12_18*y - 9/130*math.sqrt(14)*sh_12_19*z - 9/130*math.sqrt(14)*sh_12_5*x - 9/130*math.sqrt(114)*sh_12_7*x
    sh_13_20 = (3/65)*math.sqrt(285)*sh_12_18*z + (18/65)*math.sqrt(10)*sh_12_19*y - 9/130*math.sqrt(10)*sh_12_20*z - 9/130*math.sqrt(10)*sh_12_4*x - 3/65*math.sqrt(285)*sh_12_6*x
    sh_13_21 = (9/65)*math.sqrt(35)*sh_12_19*z + (9/65)*math.sqrt(35)*sh_12_20*y - 3/65*math.sqrt(15)*sh_12_21*z - 3/65*math.sqrt(15)*sh_12_3*x - 9/65*math.sqrt(35)*sh_12_5*x
    sh_13_22 = -9/65*sh_12_2*x + (9/130)*math.sqrt(154)*sh_12_20*z + (6/65)*math.sqrt(66)*sh_12_21*y - 9/65*sh_12_22*z - 9/130*math.sqrt(154)*sh_12_4*x
    sh_13_23 = -9/130*math.sqrt(2)*sh_12_1*x + (3/130)*math.sqrt(1518)*sh_12_21*z + (9/65)*math.sqrt(23)*sh_12_22*y - 9/130*math.sqrt(2)*sh_12_23*z - 3/130*math.sqrt(1518)*sh_12_3*x
    sh_13_24 = -3/130*math.sqrt(6)*sh_12_0*x - 9/65*math.sqrt(46)*sh_12_2*x + (9/65)*math.sqrt(46)*sh_12_22*z + (36/65)*sh_12_23*y - 3/130*math.sqrt(6)*sh_12_24*z
    sh_13_25 = -9/13*math.sqrt(2)*sh_12_1*x + (9/13)*math.sqrt(2)*sh_12_23*z + (3/13)*math.sqrt(3)*sh_12_24*y
    sh_13_26 = (3/26)*math.sqrt(78)*(-sh_12_0*x + sh_12_24*z)
    if lmax == 13:
        return torch.stack([
            sh_0_0,
            sh_1_0, sh_1_1, sh_1_2,
    ...
    sh_14_0 = (1/14)*math.sqrt(203)*(sh_13_0*z + sh_13_26*x)
    sh_14_1 = (1/14)*math.sqrt(29)*sh_13_0*y + (1/28)*math.sqrt(754)*sh_13_1*z + (1/28)*math.sqrt(754)*sh_13_25*x
    sh_14_2 = -1/252*math.sqrt(174)*sh_13_0*z + (1/63)*math.sqrt(1131)*sh_13_1*y + (5/252)*math.sqrt(2262)*sh_13_2*z + (5/252)*math.sqrt(2262)*sh_13_24*x + (1/252)*math.sqrt(174)*sh_13_26*x
    sh_14_3 = -1/84*math.sqrt(58)*sh_13_1*z + (5/42)*math.sqrt(29)*sh_13_2*y + (5/42)*math.sqrt(58)*sh_13_23*x + (1/84)*math.sqrt(58)*sh_13_25*x + (5/42)*math.sqrt(58)*sh_13_3*z
    sh_14_4 = -1/42*math.sqrt(29)*sh_13_2*z + (1/42)*math.sqrt(1334)*sh_13_22*x + (1/42)*math.sqrt(29)*sh_13_24*x + (2/21)*math.sqrt(58)*sh_13_3*y + (1/42)*math.sqrt(1334)*sh_13_4*z
    sh_14_5 = (1/1764)*math.sqrt(14)*(math.sqrt(154077)*sh_13_21*x + math.sqrt(6090)*sh_13_23*x - math.sqrt(6090)*sh_13_3*z + math.sqrt(140070)*sh_13_4*y + math.sqrt(154077)*sh_13_5*z)
    sh_14_6 = (1/84)*math.sqrt(4466)*sh_13_20*x + (1/84)*math.sqrt(290)*sh_13_22*x - 1/84*math.sqrt(290)*sh_13_4*z + (1/21)*math.sqrt(319)*sh_13_5*y + (1/84)*math.sqrt(4466)*sh_13_6*z
    sh_14_7 = (1/84)*math.sqrt(14)*(math.sqrt(290)*sh_13_19*x + math.sqrt(29)*sh_13_21*x - math.sqrt(29)*sh_13_5*z + math.sqrt(406)*sh_13_6*y + math.sqrt(290)*sh_13_7*z)
    sh_14_8 = (1/126)*math.sqrt(8265)*sh_13_18*x + (1/126)*math.sqrt(1218)*sh_13_20*x - 1/126*math.sqrt(1218)*sh_13_6*z + (2/63)*math.sqrt(870)*sh_13_7*y + (1/126)*math.sqrt(8265)*sh_13_8*z
    sh_14_9 = (1/84)*math.sqrt(3306)*sh_13_17*x + (1/42)*math.sqrt(174)*sh_13_19*x - 1/42*math.sqrt(174)*sh_13_7*z + (1/42)*math.sqrt(1653)*sh_13_8*y + (1/84)*math.sqrt(3306)*sh_13_9*z
    sh_14_10 = (1/84)*math.sqrt(2958)*sh_13_10*z + (1/84)*math.sqrt(2958)*sh_13_16*x + (1/84)*math.sqrt(870)*sh_13_18*x - 1/84*math.sqrt(870)*sh_13_8*z + (1/21)*math.sqrt(435)*sh_13_9*y
    sh_14_11 = (1/126)*math.sqrt(16269)*sh_13_10*y + (1/63)*math.sqrt(1479)*sh_13_11*z + (1/63)*math.sqrt(1479)*sh_13_15*x + (1/252)*math.sqrt(9570)*sh_13_17*x - 1/252*math.sqrt(9570)*sh_13_9*z
    sh_14_12 = -1/42*math.sqrt(319)*sh_13_10*z + (4/21)*math.sqrt(29)*sh_13_11*y + (1/21)*math.sqrt(145)*sh_13_12*z + (1/21)*math.sqrt(145)*sh_13_14*x + (1/42)*math.sqrt(319)*sh_13_16*x
    sh_14_13 = -1/42*math.sqrt(377)*sh_13_11*z + (1/42)*math.sqrt(1885)*sh_13_12*y + (1/42)*math.sqrt(1015)*sh_13_13*x + (1/42)*math.sqrt(377)*sh_13_15*x
    sh_14_14 = -1/126*math.sqrt(7917)*sh_13_12*x + (1/9)*math.sqrt(87)*sh_13_13*y - 1/126*math.sqrt(7917)*sh_13_14*z
    sh_14_15 = -1/42*math.sqrt(377)*sh_13_11*x + (1/42)*math.sqrt(1015)*sh_13_13*z + (1/42)*math.sqrt(1885)*sh_13_14*y - 1/42*math.sqrt(377)*sh_13_15*z
    sh_14_16 = -1/42*math.sqrt(319)*sh_13_10*x - 1/21*math.sqrt(145)*sh_13_12*x + (1/21)*math.sqrt(145)*sh_13_14*z + (4/21)*math.sqrt(29)*sh_13_15*y - 1/42*math.sqrt(319)*sh_13_16*z
    sh_14_17 = -1/63*math.sqrt(1479)*sh_13_11*x + (1/63)*math.sqrt(1479)*sh_13_15*z + (1/126)*math.sqrt(16269)*sh_13_16*y - 1/252*math.sqrt(9570)*sh_13_17*z - 1/252*math.sqrt(9570)*sh_13_9*x
    sh_14_18 = -1/84*math.sqrt(2958)*sh_13_10*x + (1/84)*math.sqrt(2958)*sh_13_16*z + (1/21)*math.sqrt(435)*sh_13_17*y - 1/84*math.sqrt(870)*sh_13_18*z - 1/84*math.sqrt(870)*sh_13_8*x
    sh_14_19 = (1/84)*math.sqrt(3306)*sh_13_17*z + (1/42)*math.sqrt(1653)*sh_13_18*y - 1/42*math.sqrt(174)*sh_13_19*z - 1/42*math.sqrt(174)*sh_13_7*x - 1/84*math.sqrt(3306)*sh_13_9*x
    sh_14_20 = (1/126)*math.sqrt(8265)*sh_13_18*z + (2/63)*math.sqrt(870)*sh_13_19*y - 1/126*math.sqrt(1218)*sh_13_20*z - 1/126*math.sqrt(1218)*sh_13_6*x - 1/126*math.sqrt(8265)*sh_13_8*x
    sh_14_21 = (1/84)*math.sqrt(14)*(math.sqrt(290)*sh_13_19*z + math.sqrt(406)*sh_13_20*y - math.sqrt(29)*sh_13_21*z - math.sqrt(29)*sh_13_5*x - math.sqrt(290)*sh_13_7*x)
    sh_14_22 = (1/84)*math.sqrt(4466)*sh_13_20*z + (1/21)*math.sqrt(319)*sh_13_21*y - 1/84*math.sqrt(290)*sh_13_22*z - 1/84*math.sqrt(290)*sh_13_4*x - 1/84*math.sqrt(4466)*sh_13_6*x
    sh_14_23 = (1/1764)*math.sqrt(14)*(math.sqrt(154077)*sh_13_21*z + math.sqrt(140070)*sh_13_22*y - math.sqrt(6090)*sh_13_23*z - math.sqrt(6090)*sh_13_3*x - math.sqrt(154077)*sh_13_5*x)
    sh_14_24 = -1/42*math.sqrt(29)*sh_13_2*x + (1/42)*math.sqrt(1334)*sh_13_22*z + (2/21)*math.sqrt(58)*sh_13_23*y - 1/42*math.sqrt(29)*sh_13_24*z - 1/42*math.sqrt(1334)*sh_13_4*x
    sh_14_25 = -1/84*math.sqrt(58)*sh_13_1*x + (5/42)*math.sqrt(58)*sh_13_23*z + (5/42)*math.sqrt(29)*sh_13_24*y - 1/84*math.sqrt(58)*sh_13_25*z - 5/42*math.sqrt(58)*sh_13_3*x
    sh_14_26 = -1/252*math.sqrt(174)*sh_13_0*x - 5/252*math.sqrt(2262)*sh_13_2*x + (5/252)*math.sqrt(2262)*sh_13_24*z + (1/63)*math.sqrt(1131)*sh_13_25*y - 1/252*math.sqrt(174)*sh_13_26*z
    sh_14_27 = -1/28*math.sqrt(754)*sh_13_1*x + (1/28)*math.sqrt(754)*sh_13_25*z + (1/14)*math.sqrt(29)*sh_13_26*y
    sh_14_28 = (1/14)*math.sqrt(203)*(-sh_13_0*x + sh_13_26*z)
    if lmax == 14:
        return torch.stack([
            sh_0_0,
            sh_1_0, sh_1_1, sh_1_2,
    ...
    sh_15_0 = (1/30)*math.sqrt(930)*(sh_14_0*z + sh_14_28*x)
    sh_15_1 = (1/15)*math.sqrt(31)*sh_14_0*y + (1/15)*math.sqrt(217)*sh_14_1*z + (1/15)*math.sqrt(217)*sh_14_27*x
    sh_15_2 = -1/870*math.sqrt(1798)*sh_14_0*z + (2/435)*math.sqrt(12586)*sh_14_1*y + (1/145)*math.sqrt(18879)*sh_14_2*z + (1/145)*math.sqrt(18879)*sh_14_26*x + (1/870)*math.sqrt(1798)*sh_14_28*x
    sh_15_3 = -1/870*math.sqrt(5394)*sh_14_1*z + (3/145)*math.sqrt(899)*sh_14_2*y + (1/290)*math.sqrt(70122)*sh_14_25*x + (1/870)*math.sqrt(5394)*sh_14_27*x + (1/290)*math.sqrt(70122)*sh_14_3*z
    sh_15_4 = -1/435*math.sqrt(2697)*sh_14_2*z + (1/174)*math.sqrt(23374)*sh_14_24*x + (1/435)*math.sqrt(2697)*sh_14_26*x + (2/435)*math.sqrt(23374)*sh_14_3*y + (1/174)*math.sqrt(23374)*sh_14_4*z
    sh_15_5 = (1/87)*math.sqrt(5394)*sh_14_23*x + (1/435)*math.sqrt(4495)*sh_14_25*x - 1/435*math.sqrt(4495)*sh_14_3*z + (1/87)*math.sqrt(4495)*sh_14_4*y + (1/87)*math.sqrt(5394)*sh_14_5*z
    sh_15_6 = (1/435)*math.sqrt(124062)*sh_14_22*x + (1/870)*math.sqrt(26970)*sh_14_24*x - 1/870*math.sqrt(26970)*sh_14_4*z + (4/145)*math.sqrt(899)*sh_14_5*y + (1/435)*math.sqrt(124062)*sh_14_6*z
    sh_15_7 = (1/870)*math.sqrt(454894)*sh_14_21*x + (1/870)*math.sqrt(37758)*sh_14_23*x - 1/870*math.sqrt(37758)*sh_14_5*z + (1/435)*math.sqrt(144739)*sh_14_6*y + (1/870)*math.sqrt(454894)*sh_14_7*z
    sh_15_8 = (1/870)*math.sqrt(415338)*sh_14_20*x + (1/435)*math.sqrt(12586)*sh_14_22*x - 1/435*math.sqrt(12586)*sh_14_6*z + (4/435)*math.sqrt(9889)*sh_14_7*y + (1/870)*math.sqrt(415338)*sh_14_8*z
    sh_15_9 = (1/435)*math.sqrt(94395)*sh_14_19*x + (1/145)*math.sqrt(1798)*sh_14_21*x - 1/145*math.sqrt(1798)*sh_14_7*z + (1/145)*math.sqrt(18879)*sh_14_8*y + (1/435)*math.sqrt(94395)*sh_14_9*z
    sh_15_10 = (1/435)*math.sqrt(85405)*sh_14_10*z + (1/435)*math.sqrt(85405)*sh_14_18*x + (1/290)*math.sqrt(8990)*sh_14_20*x - 1/290*math.sqrt(8990)*sh_14_8*z + (2/87)*math.sqrt(1798)*sh_14_9*y
    sh_15_11 = (1/435)*math.sqrt(187891)*sh_14_10*y + (1/290)*math.sqrt(34162)*sh_14_11*z + (1/290)*math.sqrt(34162)*sh_14_17*x + (1/870)*math.sqrt(98890)*sh_14_19*x - 1/870*math.sqrt(98890)*sh_14_9*z
    sh_15_12 = -1/435*math.sqrt(29667)*sh_14_10*z + (2/145)*math.sqrt(5394)*sh_14_11*y + (1/290)*math.sqrt(30566)*sh_14_12*z + (1/290)*math.sqrt(30566)*sh_14_16*x + (1/435)*math.sqrt(29667)*sh_14_18*x
    sh_15_13 = -1/435*math.sqrt(35061)*sh_14_11*z + (1/435)*math.sqrt(198679)*sh_14_12*y + (2/435)*math.sqrt(15283)*sh_14_13*z + (2/435)*math.sqrt(15283)*sh_14_15*x + (1/435)*math.sqrt(35061)*sh_14_17*x
    sh_15_14 = -1/870*math.sqrt(163618)*sh_14_12*z + (4/435)*math.sqrt(12586)*sh_14_13*y + (2/435)*math.sqrt(26970)*sh_14_14*x + (1/870)*math.sqrt(163618)*sh_14_16*x
    sh_15_15 = -1/435*math.sqrt(94395)*sh_14_13*x + (1/29)*math.sqrt(899)*sh_14_14*y - 1/435*math.sqrt(94395)*sh_14_15*z
    sh_15_16 = -1/870*math.sqrt(163618)*sh_14_12*x + (2/435)*math.sqrt(26970)*sh_14_14*z + (4/435)*math.sqrt(12586)*sh_14_15*y - 1/870*math.sqrt(163618)*sh_14_16*z
    sh_15_17 = -1/435*math.sqrt(35061)*sh_14_11*x - 2/435*math.sqrt(15283)*sh_14_13*x + (2/435)*math.sqrt(15283)*sh_14_15*z + (1/435)*math.sqrt(198679)*sh_14_16*y - 1/435*math.sqrt(35061)*sh_14_17*z
    sh_15_18 = -1/435*math.sqrt(29667)*sh_14_10*x - 1/290*math.sqrt(30566)*sh_14_12*x + (1/290)*math.sqrt(30566)*sh_14_16*z + (2/145)*math.sqrt(5394)*sh_14_17*y - 1/435*math.sqrt(29667)*sh_14_18*z
    sh_15_19 = -1/290*math.sqrt(34162)*sh_14_11*x + (1/290)*math.sqrt(34162)*sh_14_17*z + (1/435)*math.sqrt(187891)*sh_14_18*y - 1/870*math.sqrt(98890)*sh_14_19*z - 1/870*math.sqrt(98890)*sh_14_9*x
    sh_15_20 = -1/435*math.sqrt(85405)*sh_14_10*x + (1/435)*math.sqrt(85405)*sh_14_18*z + (2/87)*math.sqrt(1798)*sh_14_19*y - 1/290*math.sqrt(8990)*sh_14_20*z - 1/290*math.sqrt(8990)*sh_14_8*x
    sh_15_21 = (1/435)*math.sqrt(94395)*sh_14_19*z + (1/145)*math.sqrt(18879)*sh_14_20*y - 1/145*math.sqrt(1798)*sh_14_21*z - 1/145*math.sqrt(1798)*sh_14_7*x - 1/435*math.sqrt(94395)*sh_14_9*x
    sh_15_22 = (1/870)*math.sqrt(415338)*sh_14_20*z + (4/435)*math.sqrt(9889)*sh_14_21*y - 1/435*math.sqrt(12586)*sh_14_22*z - 1/435*math.sqrt(12586)*sh_14_6*x - 1/870*math.sqrt(415338)*sh_14_8*x
    sh_15_23 = (1/870)*math.sqrt(454894)*sh_14_21*z + (1/435)*math.sqrt(144739)*sh_14_22*y - 1/870*math.sqrt(37758)*sh_14_23*z - 1/870*math.sqrt(37758)*sh_14_5*x - 1/870*math.sqrt(454894)*sh_14_7*x
    sh_15_24 = (1/435)*math.sqrt(124062)*sh_14_22*z + (4/145)*math.sqrt(899)*sh_14_23*y - 1/870*math.sqrt(26970)*sh_14_24*z - 1/870*math.sqrt(26970)*sh_14_4*x - 1/435*math.sqrt(124062)*sh_14_6*x
    sh_15_25 = (1/87)*math.sqrt(5394)*sh_14_23*z + (1/87)*math.sqrt(4495)*sh_14_24*y - 1/435*math.sqrt(4495)*sh_14_25*z - 1/435*math.sqrt(4495)*sh_14_3*x - 1/87*math.sqrt(5394)*sh_14_5*x
    sh_15_26 = -1/435*math.sqrt(2697)*sh_14_2*x + (1/174)*math.sqrt(23374)*sh_14_24*z + (2/435)*math.sqrt(23374)*sh_14_25*y - 1/435*math.sqrt(2697)*sh_14_26*z - 1/174*math.sqrt(23374)*sh_14_4*x
    sh_15_27 = -1/870*math.sqrt(5394)*sh_14_1*x + (1/290)*math.sqrt(70122)*sh_14_25*z + (3/145)*math.sqrt(899)*sh_14_26*y - 1/870*math.sqrt(5394)*sh_14_27*z - 1/290*math.sqrt(70122)*sh_14_3*x
    sh_15_28 = -1/870*math.sqrt(1798)*sh_14_0*x - 1/145*math.sqrt(18879)*sh_14_2*x + (1/145)*math.sqrt(18879)*sh_14_26*z + (2/435)*math.sqrt(12586)*sh_14_27*y - 1/870*math.sqrt(1798)*sh_14_28*z
    sh_15_29 = -1/15*math.sqrt(217)*sh_14_1*x + (1/15)*math.sqrt(217)*sh_14_27*z + (1/15)*math.sqrt(31)*sh_14_28*y
    sh_15_30 = (1/30)*math.sqrt(930)*(-sh_14_0*x + sh_14_28*z)
    if lmax == 15:
        return torch.stack([
            sh_0_0,
            sh_1_0, sh_1_1, sh_1_2,
    ...
    sh_16_0 = (1/8)*math.sqrt(66)*(sh_15_0*z + sh_15_30*x)
    sh_16_1 = (1/16)*math.sqrt(33)*sh_15_0*y + (3/32)*math.sqrt(110)*sh_15_1*z + (3/32)*math.sqrt(110)*sh_15_29*x
    sh_16_2 = -1/992*math.sqrt(2046)*sh_15_0*z + (3/248)*math.sqrt(1705)*sh_15_1*y + (3/992)*math.sqrt(98890)*sh_15_2*z + (3/992)*math.sqrt(98890)*sh_15_28*x + (1/992)*math.sqrt(2046)*sh_15_30*x
    sh_16_3 = -3/992*math.sqrt(682)*sh_15_1*z + (3/496)*math.sqrt(9889)*sh_15_2*y + (1/496)*math.sqrt(207669)*sh_15_27*x + (3/992)*math.sqrt(682)*sh_15_29*x + (1/496)*math.sqrt(207669)*sh_15_3*z
    sh_16_4 = -3/496*math.sqrt(341)*sh_15_2*z + (9/496)*math.sqrt(2387)*sh_15_26*x + (3/496)*math.sqrt(341)*sh_15_28*x + (1/124)*math.sqrt(7161)*sh_15_3*y + (9/496)*math.sqrt(2387)*sh_15_4*z
    sh_16_5 = (9/992)*math.sqrt(8866)*sh_15_25*x + (1/496)*math.sqrt(5115)*sh_15_27*x - 1/496*math.sqrt(5115)*sh_15_3*z + (9/496)*math.sqrt(1705)*sh_15_4*y + (9/992)*math.sqrt(8866)*sh_15_5*z
    sh_16_6 = (5/992)*math.sqrt(26598)*sh_15_24*x + (3/992)*math.sqrt(3410)*sh_15_26*x - 3/992*math.sqrt(3410)*sh_15_4*z + (3/248)*math.sqrt(4433)*sh_15_5*y + (5/992)*math.sqrt(26598)*sh_15_6*z
    sh_16_7 = (15/496)*math.sqrt(682)*sh_15_23*x + (3/992)*math.sqrt(4774)*sh_15_25*x - 3/992*math.sqrt(4774)*sh_15_5*z + (5/496)*math.sqrt(7161)*sh_15_6*y + (15/496)*math.sqrt(682)*sh_15_7*z
    sh_16_8 = (3/496)*math.sqrt(15686)*sh_15_22*x + (1/496)*math.sqrt(14322)*sh_15_24*x - 1/496*math.sqrt(14322)*sh_15_6*z + (3/62)*math.sqrt(341)*sh_15_7*y + (3/496)*math.sqrt(15686)*sh_15_8*z
    sh_16_9 = (11/992)*math.sqrt(4278)*sh_15_21*x + (3/496)*math.sqrt(2046)*sh_15_23*x - 3/496*math.sqrt(2046)*sh_15_7*z + (3/496)*math.sqrt(23529)*sh_15_8*y + (11/992)*math.sqrt(4278)*sh_15_9*z
    sh_16_10 = (33/992)*math.sqrt(434)*sh_15_10*z + (33/992)*math.sqrt(434)*sh_15_20*x + (3/992)*math.sqrt(10230)*sh_15_22*x - 3/992*math.sqrt(10230)*sh_15_8*z + (11/248)*math.sqrt(465)*sh_15_9*y
    sh_16_11 = (33/496)*math.sqrt(217)*sh_15_10*y + (3/496)*math.sqrt(11935)*sh_15_11*z + (3/496)*math.sqrt(11935)*sh_15_19*x + (11/992)*math.sqrt(930)*sh_15_21*x - 11/992*math.sqrt(930)*sh_15_9*z
    sh_16_12 = -33/496*math.sqrt(31)*sh_15_10*z + (3/124)*math.sqrt(1705)*sh_15_11*y + (1/496)*math.sqrt(97185)*sh_15_12*z + (1/496)*math.sqrt(97185)*sh_15_18*x + (33/496)*math.sqrt(31)*sh_15_20*x
    sh_16_13 = -3/496*math.sqrt(4433)*sh_15_11*z + (1/496)*math.sqrt(252681)*sh_15_12*y + (3/992)*math.sqrt(38874)*sh_15_13*z + (3/992)*math.sqrt(38874)*sh_15_17*x + (3/496)*math.sqrt(4433)*sh_15_19*x
    sh_16_14 = -1/992*math.sqrt(186186)*sh_15_12*z + (3/248)*math.sqrt(7161)*sh_15_13*y + (3/992)*math.sqrt(34782)*sh_15_14*z + (3/992)*math.sqrt(34782)*sh_15_16*x + (1/992)*math.sqrt(186186)*sh_15_18*x
    sh_16_15 = -3/992*math.sqrt(23870)*sh_15_13*z + (3/496)*math.sqrt(28985)*sh_15_14*y + (1/248)*math.sqrt(34782)*sh_15_15*x + (3/992)*math.sqrt(23870)*sh_15_17*x
    sh_16_16 = -3/248*math.sqrt(3410)*sh_15_14*x + (1/31)*math.sqrt(1023)*sh_15_15*y - 3/248*math.sqrt(3410)*sh_15_16*z
    sh_16_17 = -3/992*math.sqrt(23870)*sh_15_13*x + (1/248)*math.sqrt(34782)*sh_15_15*z + (3/496)*math.sqrt(28985)*sh_15_16*y - 3/992*math.sqrt(23870)*sh_15_17*z
    sh_16_18 = -1/992*math.sqrt(186186)*sh_15_12*x - 3/992*math.sqrt(34782)*sh_15_14*x + (3/992)*math.sqrt(34782)*sh_15_16*z + (3/248)*math.sqrt(7161)*sh_15_17*y - 1/992*math.sqrt(186186)*sh_15_18*z
    sh_16_19 = -3/496*math.sqrt(4433)*sh_15_11*x - 3/992*math.sqrt(38874)*sh_15_13*x + (3/992)*math.sqrt(38874)*sh_15_17*z + (1/496)*math.sqrt(252681)*sh_15_18*y - 3/496*math.sqrt(4433)*sh_15_19*z
    sh_16_20 = -33/496*math.sqrt(31)*sh_15_10*x - 1/496*math.sqrt(97185)*sh_15_12*x + (1/496)*math.sqrt(97185)*sh_15_18*z + (3/124)*math.sqrt(1705)*sh_15_19*y - 33/496*math.sqrt(31)*sh_15_20*z
    sh_16_21 = -3/496*math.sqrt(11935)*sh_15_11*x + (3/496)*math.sqrt(11935)*sh_15_19*z + (33/496)*math.sqrt(217)*sh_15_20*y - 11/992*math.sqrt(930)*sh_15_21*z - 11/992*math.sqrt(930)*sh_15_9*x
    sh_16_22 = -33/992*math.sqrt(434)*sh_15_10*x + (33/992)*math.sqrt(434)*sh_15_20*z + (11/248)*math.sqrt(465)*sh_15_21*y - 3/992*math.sqrt(10230)*sh_15_22*z - 3/992*math.sqrt(10230)*sh_15_8*x
    sh_16_23 = (11/992)*math.sqrt(4278)*sh_15_21*z + (3/496)*math.sqrt(23529)*sh_15_22*y - 3/496*math.sqrt(2046)*sh_15_23*z - 3/496*math.sqrt(2046)*sh_15_7*x - 11/992*math.sqrt(4278)*sh_15_9*x
    sh_16_24 = (3/496)*math.sqrt(15686)*sh_15_22*z + (3/62)*math.sqrt(341)*sh_15_23*y - 1/496*math.sqrt(14322)*sh_15_24*z - 1/496*math.sqrt(14322)*sh_15_6*x - 3/496*math.sqrt(15686)*sh_15_8*x
    sh_16_25 = (15/496)*math.sqrt(682)*sh_15_23*z + (5/496)*math.sqrt(7161)*sh_15_24*y - 3/992*math.sqrt(4774)*sh_15_25*z - 3/992*math.sqrt(4774)*sh_15_5*x - 15/496*math.sqrt(682)*sh_15_7*x
    sh_16_26 = (5/992)*math.sqrt(26598)*sh_15_24*z + (3/248)*math.sqrt(4433)*sh_15_25*y - 3/992*math.sqrt(3410)*sh_15_26*z - 3/992*math.sqrt(3410)*sh_15_4*x - 5/992*math.sqrt(26598)*sh_15_6*x
    sh_16_27 = (9/992)*math.sqrt(8866)*sh_15_25*z + (9/496)*math.sqrt(1705)*sh_15_26*y - 1/496*math.sqrt(5115)*sh_15_27*z - 1/496*math.sqrt(5115)*sh_15_3*x - 9/992*math.sqrt(8866)*sh_15_5*x
    sh_16_28 = -3/496*math.sqrt(341)*sh_15_2*x + (9/496)*math.sqrt(2387)*sh_15_26*z + (1/124)*math.sqrt(7161)*sh_15_27*y - 3/496*math.sqrt(341)*sh_15_28*z - 9/496*math.sqrt(2387)*sh_15_4*x
    sh_16_29 = -3/992*math.sqrt(682)*sh_15_1*x + (1/496)*math.sqrt(207669)*sh_15_27*z + (3/496)*math.sqrt(9889)*sh_15_28*y - 3/992*math.sqrt(682)*sh_15_29*z - 1/496*math.sqrt(207669)*sh_15_3*x
    sh_16_30 = -1/992*math.sqrt(2046)*sh_15_0*x - 3/992*math.sqrt(98890)*sh_15_2*x + (3/992)*math.sqrt(98890)*sh_15_28*z + (3/248)*math.sqrt(1705)*sh_15_29*y - 1/992*math.sqrt(2046)*sh_15_30*z
    sh_16_31 = -3/32*math.sqrt(110)*sh_15_1*x + (3/32)*math.sqrt(110)*sh_15_29*z + (1/16)*math.sqrt(33)*sh_15_30*y
    sh_16_32 = (1/8)*math.sqrt(66)*(-sh_15_0*x + sh_15_30*z)
    return torch.stack([
        sh_0_0,
        sh_1_0, sh_1_1, sh_1_2,
        sh_2_0, sh_2_1, sh_2_2, sh_2_3, sh_2_4,
